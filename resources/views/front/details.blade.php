            ...
            <div id="Benefits" class="flex flex-col gap-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div
                        ...
                        <div class="flex gap-3 items-center">
                            <div class="size-6 flex shrink-0">
                                <img src="{{ asset('assets/images/icons/shield-tick.svg') }}" alt="icon"
                                    class="size-full" />
                            </div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="pb-4 border-b border-[#EDEEF0]">
                        <div class="flex gap-3">
                            ...
                            <div class="size-[50px] flex shrink-0 rounded-full overflow-hidden">
                                <img src="{{ asset('assets/images/photos/photo-1.png') }}" alt="icon"
                                    class="size-full" />
                            </div>
                    ...
                    <div class="pb-4 border-b border-[#EDEEF0]">
                        <div class="flex gap-3">
                            <!-- photo -->
                            <div class="size-[50px] flex shrink-0 rounded-full overflow-hidden">
                                <img src="{{ asset('assets/images/photos/photo-2.png') }}" alt="icon"
                                    class="size-full" />
                            </div>
                            <div class="flex flex-col gap-[6px] w-full">
                                <div class="flex items-center justify-between">
                    ...
                    <div class="pb-4">
                        <div class="flex gap-3">
                            <!-- photo -->
                            <div class="size-[50px] flex shrink-0 rounded-full overflow-hidden">
                                <img src="{{ asset('assets/images/photos/photo-3.png') }}" alt="icon"
                                    class="size-full" />
                            </div>
                            <div class="flex flex-col gap-[6px] w-full">
                                <div class="flex items-center justify-between">
        ...
        <div id="Bottom-nav"
            ...
            <div class="flex items-center justify-between p-5 relative z-10">
                <div class="flex flex-col gap-1 w-fit">
                    <p class="font-bold text-xl leading-[30px]">Rp.{{ number_format($product->price, '0', ',', '.') }}
                    </p>
                    <p class="text-sm leading-[21px]">/day</p>
                </div>
                <a href="{{ route('front.booking', $product->slug) }}"
                    class="rounded-full p-[12px_24px] bg-[#FCCF2F] font-bold w-fit">Rent Now</a>
            </div>
        </div>
