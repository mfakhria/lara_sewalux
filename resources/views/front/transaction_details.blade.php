...
@section('title', 'SewaLux - Transaction Detail')
@section('content')
    ...
    <main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
            ...
            @if ($details->is_paid)
                <div id="Payment-success" class="flex items-center rounded-2xl p-[14px_16px] gap-4 bg-black text-white">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="text-xs leading-[18px]">Pembayaran Anda sudah kami terima dan silahkan menunggu instruksi
                            selanjutnya</p>
                    </div>
                </div>
            @else
                ...
                @else
                    <div class="info-card flex flex-col gap-2">
                        ...
                        <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F4F4F6]">
                            ...
                            <div class="flex flex-col gap-1">
                                <p class="font-semibold">{{ $details->address }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div id="Bottom-nav"
            ...
            <div class="flex items-center justify-between p-5 relative z-10">
                <a href="" class="rounded-full p-[12px_24px] bg-[#FCCF2F] font-bold w-full text-center">Contact
                    Customer Service</a>
            </div>
        </div>
    </main>
