    ...
    <main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
        ...
        @if ($errors->any())
            @foreach ($errors->all() as $error)
                <div class="py-3 w-full rounded-3xl bg-[#FCCF2F] text-white">{{ $error }}</div>
            @endforeach
        @endif
        <form method="POST" action="{{ route('front.booking.save', $product->slug) }}"
            ...
            <div class="flex flex-col px-5 gap-2">
                ...
                <div id="Menus" class="flex flex-col gap-4">
                    ...
                    <div class="tabs-contents">
                        <div id="pickup-tab" class="tabcontent flex-col gap-4 hidden">
                        ...
                        <div id="delivery-tab" class="tabcontent flex-col hidden">
                            <div class="flex flex-col gap-1">
                            ...
                            <textarea name="address" id="address"
                                ...
                                placeholder="Tuliskan alamat rumah anda dengan lengkap agar memudahkan kurir" rows="4"></textarea>
                            <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F6F6F6] mt-5">
                                <div class="w-6 h-6 flex shrink-0">
                                    <img src="{{ asset('assets/images/icons/ticket-discount-black.svg') }}"
                                        alt="icon" />
                                </div>
                                <p class="text-sm leading-[24px] text-[#6E6E70]">Biaya kirim barang gratis untuk
                                    seluruh
